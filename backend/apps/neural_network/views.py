...
#from backend.apps.portfolio.models import Achievement
...
def ai_analysis(request, achievement_id):
    ...
    # proof_img = achievement.proof_file
    OCR.recognize_image(
        image_path="backend/apps/neural_network/test_images/image2.png",
        lang="ru,en",
        output_dir="new_output",
        save_artifacts=True
    )

    with open("new_output/image2_result.json", "r", encoding="utf-8") as f:
        data = json.load(f)
...
ai_analysis(request=None, achievement_id=1)