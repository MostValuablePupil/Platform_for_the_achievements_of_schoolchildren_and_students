...
from apps.events.parsers.olimpiada_ru import OlimpiadaRuParser
from apps.events.parsers.hse_olymp import HseOlympParser
from apps.events.parsers.hacklist import HacklistParser
from apps.events.parsers.postupi_online import PostupiOnlineParser


# Реестр доступных парсеров
PARSERS = {
    'urfu_izumrud': UrfuIzumrudParser,
    'olimpiada_ru': OlimpiadaRuParser,
    'hse_olymp': HseOlympParser,
    'hacklist': HacklistParser,
    'postupi_online': PostupiOnlineParser,
}
