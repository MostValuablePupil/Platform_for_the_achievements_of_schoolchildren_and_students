...
from apps.neural_network.views import enqueue_achievement_ai_analysis

from .models import Achievement, AchievementFile, Badge, Event, UserBadge
...
class AchievementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "event_type_display",
            "level_category",
            "level_category_display",
            "achievement_level",
            "achievement_level_display",
            "organization",
            "link",
            "status",
            "event_date",
    ...
    def create(self, validated_data):
        ...
        uploaded_files = request.FILES.getlist("uploaded_files") if request and request.FILES else []
        ...
        with transaction.atomic():
            ...
            for uploaded_file in uploaded_files:
                AchievementFile.objects.create(achievement=achievement, file=uploaded_file)

            if uploaded_files:
                transaction.on_commit(
                    lambda achievement_id=achievement.id: enqueue_achievement_ai_analysis(achievement_id)
                )
