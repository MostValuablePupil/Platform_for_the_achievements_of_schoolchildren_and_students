    ...
    <div className="space-y-4 max-w-7xl mx-auto pb-10 animate-fade-in px-4 md:px-0">
      ...
      <div className="hidden lg:block">
        ...
        <div className="grid grid-cols-12 gap-6 mt-6">
          ...
          {/* ЛЕВАЯ КОЛОНКА (4/12): ЛИДЕРБОРД + ПРОГРЕСС */}
          <div className="col-span-12 lg:col-span-4 space-y-6">
            ...
            <div className="bg-[#1a2332] border border-gray-800 rounded-2xl p-6 animate-fade-in-up delay-100">
              ...
              {/* ФИЛЬТРЫ С CUSTOM SELECT */}
              <div className="mb-4 space-y-3">
                 {isUniversityStudent ? (
                   // Фильтры для Студента ВУЗА
                   <>
                     <CustomSelect
                       label=""
                   ...
                   <>
                     ...
                     <div className="relative">
                        ...
                        <input 
                          ...
                          className="w-full pl-10 pr-4 py-3 bg-[#0f1419] border border-gray-700 rounded-xl text-sm text-white placeholder-gray-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all"
                        />
                     </div>
              ...
              <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                {leaderboardLoading ? (
                  ...
                  <p className="text-xs text-gray-500 text-center py-4">Нет участников по фильтру</p>
                )}
              </div>
            </div>
          ...
          {/* ПРАВАЯ КОЛОНКА (8/12): НАГРАДЫ, СТАТИСТИКА, ДОСТИЖЕНИЯ */}
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-[100] animate-fade-in">
          <div className="bg-[#1a2332] border border-gray-800 rounded-2xl w-full max-w-lg overflow-hidden animate-scale-in">
            ...
            <form onSubmit={handleSaveProfile} className="p-6 space-y-4">
              ...
              <div><label className="block text-sm text-gray-400 mb-1">Отчество</label><input type="text" autoComplete="off" value={editFormData.middle_name} onChange={e => setEditFormData({...editFormData, middle_name: e.target.value})} className="w-full bg-[#0f1419] border border-gray-700 rounded-xl px-4 py-2.5 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all" placeholder="Иванович" /></div>
